...
$address = 'hasan@green-deal-finance.co.uk';

$e_subject = 'Green Deal Finance Loan Callback Request from ' . $name . '.';
$e_body = "Request Caalback from $name from $website their message is as follows." . "\r\n" . "\r\n";
$e_content = "\"$comments\"" . "\r\n" . "\r\n";
